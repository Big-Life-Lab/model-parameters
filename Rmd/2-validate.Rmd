...
| date::[<date format>] | Use when the variable is a string that contains a date. The format of the date should be specified using [R notation](https://www.r-bloggers.com/2013/08/date-formats-in-r/) |
